...
import com.amazonaws.services.ecs.model.{ContainerDefinition, Device, DockerVolumeConfiguration, HealthCheck, HostEntry, HostVolumeProperties, KernelCapabilities, KeyValuePair, LinuxParameters, LogConfiguration, MountPoint, PortMapping, RegisterTaskDefinitionRequest, RegisterTaskDefinitionResult, RepositoryCredentials, Secret, SystemControl, Tag, TaskDefinitionPlacementConstraint, Tmpfs, Ulimit, Volume, VolumeFrom}
...
class EcsTaskRegisterOperator(operatorName: String,
