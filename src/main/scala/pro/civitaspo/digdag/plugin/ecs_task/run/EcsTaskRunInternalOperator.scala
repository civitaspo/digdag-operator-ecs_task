...
import com.amazonaws.services.ecs.model.{AwsVpcConfiguration, ContainerOverride, Failure, KeyValuePair, NetworkConfiguration, PlacementConstraint, PlacementStrategy, RunTaskRequest, RunTaskResult, Tag, TaskOverride}
...
class EcsTaskRunInternalOperator(operatorName: String,
